 ...
 * Use the {@link PendentesFragment#newInstance} factory method to
...
public class PendentesFragment extends Fragment {
     ...
     * @return A new instance of fragment PendentesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PendentesFragment newInstance(String param1, String param2) {
        PendentesFragment fragment = new PendentesFragment();
    ...
    private void popularListaCompromisso(){
        ...
        databaseReference.child("compromissos").orderByChild("status").equalTo("Pendente").addValueEventListener(new ValueEventListener() {
            @Override
